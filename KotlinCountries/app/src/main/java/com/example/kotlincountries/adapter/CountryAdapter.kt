...
class CountryAdapter(val countryList : ArrayList<Country>) : RecyclerView.Adapter<CountryAdapter.CountryViewHolder>(), CountryClickListener {
    ...
    override fun onBindViewHolder(holder: CountryViewHolder, position: Int) {
        ...
        /*
        holder.view.itemName.text = countryList[position].countryName
        holder.view.itemRegion.text = countryList[position].countryRegion
        holder.view.itemImage.downloadFromUrl(countryList[position].imageUrl, placeholderProgressBar(holder.view.context))
